  ...
  <div class="row center_o1">
   ...
   <div class="col-md-7">
     <div class="center_o1r text-end">
	  <h6 class="mb-0 col_red"><a href="index.php">Home</a> <span class="me-2 ms-2 text-light"><i class="fa fa-caret-right align-middle"></i></span> Services</h6>
	 </div>
   </div>
  </div>
 </div>
 ...
 <div class="container-xl">
  ...
  <div class="accordion-item">
   <h2 class="accordion-header" id="headingOne">
	 ...
	 Offering an unparalleled movie experience
     </button>
   </h2>
   <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
     <div class="accordion-body">
	 At Planet, we transform every movie outing into a memorable experience with our top-tier facilities and exceptional service. From the latest blockbuster hits to cherished classics, we offer a cinematic journey that's both immersive and enjoyable.     </div>
   </div>
  </div>
  ...
  <div class="accordion-item">
   ...
   <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
     <div class="accordion-body">
	 Enjoy the ultimate comfort with our plush, reclining seats, designed to provide you with a first-class movie experience. Perfect for long films or a relaxing night out.
     </div>
   </div>
 </div>
  ...
  <div class="accordion-item">
   ...
   <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
     <div class="accordion-body">
	 Experience films in stunning clarity with our state-of-the-art digital projection and immersive surround sound systems, ensuring every detail of the movie is crystal clear.
     </div>
   </div>
 </div>
</div>
