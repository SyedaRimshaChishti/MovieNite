...
<head>
    ...
    <style>
        ...
        .pagination .page-link {
            color: #e53935; /* Red for page links */
        }
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="view_movies.php?id=<?php echo $row['booking_id']; ?>" class="btn btn-info btn-sm">View</a>
                                <a href="edit_movies.php?id=<?php echo $row['booking_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href='delete_movies.php?id=<?php echo htmlspecialchars($row["booking_id"]); ?>' class="btn btn-danger btn-sm">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
