                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="view_user.php?id=<?php echo $row['user_id']; ?>" class="btn btn-info btn-sm">View</a>
                                <a href="edit_user.php?id=<?php echo $row['user_id']; ?>" class="btn btn-warning btn-sm">Edit</a>
                                <a href='delete_user.php?id=<?php echo htmlspecialchars($row["user_id"]); ?>' class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <?php endwhile; ?>
                    </tbody>
