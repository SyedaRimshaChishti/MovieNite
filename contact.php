    ...
    <div class="contact_1i row">
	 ...
	 <div class="col-md-10 col-10">
	  <div class="contact_1ir">
	   ...
	   <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=CllgCHrlGBGqLkrXFPKwqSfHlXjjvBmnKdMDJRFnXzHKrtZZXVgCgGJMsgnLphVZmnBpPVxtmBV" class="text-white">Movienite@gmail.com</a>	  </div>
	 </div>
	</div>
   </div>
   <div class="col-md-3">
   ...
   <div class="col-md-3">
    <div class="contact_2r">
	  ...
	  <p><i class="fa fa-phone col_red me-1"></i> +123 123 456</p>
	    <p><i class="fa fa-envelope col_red me-1"></i>     <a href="https://mail.google.com/mail/u/0/?tab=rm&ogbl#inbox?compose=CllgCHrlGBGqLkrXFPKwqSfHlXjjvBmnKdMDJRFnXzHKrtZZXVgCgGJMsgnLphVZmnBpPVxtmBV" class="text-white">Movienite@gmail.com</a></p>
